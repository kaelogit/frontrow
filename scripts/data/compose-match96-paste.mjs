...
const pastePath = path.join(scriptDir, "pastes", "match-96.txt");
const headerPath = path.join(patchesDir, "match-96-user-paste.txt");
const bodyChunks = [
  "match-96-listings-part1.txt",
  "match-96-listings-rest-a.txt",
  "match-96-listings-rest-b.txt",
];
...
const listings = (paste.match(/BC Place Stadium - Section/g) || []).length;
